...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="NO" LPM_CVALUE=FFFFFFFF LPM_WIDTH=32 result
...
module  const1_lpm_constant_be9
	( 
	result) ;
	output   [31:0]  result;
	...
	assign
		result = {32{1'b1}};
endmodule //const1_lpm_constant_be9
//VALID FILE
...
module const1 (
	...
	const1_lpm_constant_be9	const1_lpm_constant_be9_component (
				.result (sub_wire0));
